...
class WonderPlugin_Carousel_Update {
	...
	function show_plugin_update_message( $plugin_data, $r ) {
		...
		else
		{
			...
			{
				echo '<br>To get upgrades, please <a href="'. admin_url('admin.php?page=wonderplugin_carousel_register') . '">enter your license key</a> or <a href="https://www.wonderplugin.com/https://www.wonderplugin.com/register-faq/#manualupdate" target="_blank">update the plugin manually</a>.';
			}
		}
	}
}