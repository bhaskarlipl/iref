...
jQuery(".slide").click(function(){
     jQuery(".apply-fomr-top").slideToggle();
    });
});
</script>
	...
	<?php $preloader_class = ''; if ( willow_option( 'enable_preloader', 1 ) ) $preloader_class .= 'js-preloader'; 
	 ...
	 if(is_page_template('our-team-page.php')){ $preloader_class.=" about-us-body menu-color about-us single-project"; }
						...
						<?php elseif ( $media == 'video' ) : ?>
							...
							<?php else : ?>
								<li class="<?php echo "$color_scheme-scheme hero-slide-$text_style"; ?>">
									...
									<video id="<?php echo $video_id; ?>" class="<?php echo $enable_parallax ? 'parallax js-parallax' : ''; ?> video-background js-video-background" poster="<?php echo $video_poster; ?>" preload="none" loop volume=<?php echo $video_mute ? 0 : 1 ;?> data-section="#hero" data-ratio="<?php echo $video_ratio; ?>" data-parallax="element">
		...
		<div id="document" class="document">
			...
			<header id="header" class="header-section section navbar navbar-default header-floating" role="navigation">
                ...
                <?php wp_nav_menu( array(
                  ...
                  <?php /*?><div class="header-separator pull-left visible-md visible-lg"></div><?php */?>
				</div>
    ...
    if(is_page(548)) {
			if ( $show_page_title ) : ?>
			<section id="title" class="title-section join_us_page">
				<div class="join_us_banner_text">
           <?php 
				 $meta_values = get_post_meta(get_the_ID(), 'about_us_banner', TRUE);
				 echo '<img src="'.$meta_values.'">';
				 echo '<div class="banner_text">'. $meta_text = get_post_meta(get_the_ID(), 'join_us_text', TRUE).'</div>';
				?>
				</div>
			</section>
			<?php endif; }
...
jQuery(document).ready(function(){
   ...
   jQuery('input[type=file]').change(function(e){
       ...
       var file1 = jQuery('input[type=file]').val();
  
	  jQuery(".file-upload span").html(file1);
